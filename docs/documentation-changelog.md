...
## 2026-09-25 — Staged massive-scale work and feature integration

Decomposed [SC01–SC16](maintainers/scaling.md) into independently staged children with specific deliverables, dependencies and exit evidence; refined existing [PF](maintainers/performance.md) and [production-data](maintainers/production-data.md) work in place, including explicit operational-record/query children. Added [SF01–SF18](maintainers/scaling-feature-readiness.md) for shared performance/behavioral evidence and feature/public-release readiness. Each new or clarified research-derived item links the relevant massive-scale chapter; existing parent ownership and checked states remain intact.

Separated truly deferred work into [regional](maintainers/scaling-long-term/regions.md), [memory/storage](maintainers/scaling-long-term/memory-storage.md), [advanced simulation](maintainers/scaling-long-term/simulation.md) and [operations](maintainers/scaling-long-term/operations.md) backlogs. [Sequence and promotion gates](scaling/sequence-and-gates.md) distinguish NOW foundations, SOON growing-world/public-release requirements and LATER conditional distribution. Early source/authority/query seams stay near-term; public privacy/recovery/cost safeguards apply before shared release rather than waiting for P6. Optional voice, economy and asset requirements follow their actual P3/P4/P5 consumer.

Mapped all research chapters through [research coverage](scaling/research-coverage.md), connected the [feature architecture guide](scaling/feature-integration.md) and [product roadmap](../archive/05-project/roadmap.md#massive-scale-research-integration-by-product-stage), and updated main navigation, identity, knowledge, targeted-action and mechanic-growth guidance. Corrected stale PF language that would pause native progression for memory backlog or repeat removal of the already retired global thought-interval setting. Snapshot/replay optimization still cannot complete D1/D2's canonical-record migration. No runtime implementation, tests, benchmark, deployment, spending or capacity claim is delivered; new execution and acceptance items remain open.
...
The research branch subsequently incorporated main revision `03105fed9209c126e4e69e9faeb4687f42d1e74a` before the current-code remediation audit. Its accepted shared-world regional priority, human-private data restrictions and removal of arbitrary content-count caps supersede conflicting earlier research suggestions; the source research remains dated evidence, not permission to reverse those decisions.
