...
For a fresh conversation continuing hearing/captions, start with the [audited handoff](hearing-handoff.md), then its linked canonical specifications and HE/PF task owners.
...
| Parameterized action grounding and native activities (AG05 subtracker) | [Action capabilities](action-capabilities.md)                       | [Capability contract](../capability-contract.md); INV/AG/SW/EPR retain their existing ownership                                                                                                                                                                |
