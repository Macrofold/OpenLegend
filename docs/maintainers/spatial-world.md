...
| SW08       | 3D bodily sight/hearing, range-first sound, ordered attenuation, cache invalidation and route privacy              | EPR03 private acquisition, graded unknown/muffled sound contacts and dense audience/first-exposure scaling         |
...
| SW10       | WorldRenderer seam, upright lit sprites plus meshes, shared presentation component and seam interpolation          | Minimal RenderWorldView, directional/3D rigs, late model loading and full representation swapping                  |
...
- [x] **SW18.2** Upright Y-billboards and cutout/dither depth separate from emissive/blended effects; retain mixed mesh art and alpha picking. Support-aware visual interpolation prevents a descending ramp from snapping prematurely onto underlying ground.
