...
- [x] Reject selected evidence when forgetting/correction, exact source version or restore generation changes during attention. Required/fallback selections share this boundary. Automated delayed-provider coverage remains part of the existing deferred validation gate; this is implementation, not live behavioral acceptance.
