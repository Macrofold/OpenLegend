...
- [ ] **PF12.3 / PF09 / EPR02–03** Implement dependency-valid static-object exposure reuse, then dirty region/target updates. Preserve episode identity, source-scoped names, capability/geometry invalidation, ordered acquisition and complete output; do not retain draft entities.
...
Dense 8x is not complete. The next implementation priority is PF12.3 plus PF12.5, with PF12.4 for auditory scaling and PF12.7 for visible frame cost. No new density or geometry limits were raised by this rebase.
