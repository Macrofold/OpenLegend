...
A presentation lifetime stores its duration and elapsed active reading time, sampled against an injected monotonic presentation clock. Queued captions have not started their reading lifetime. An illustrative boundary is:
