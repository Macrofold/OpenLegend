...
The client admits 1–32 questions, 2–255 Choice options, and 2–10 Score levels. These are application limits except where also constrained by the provider. Score levels start at zero, and interpolation is a rubric position, not a physical constant or calibrated outcome probability. [Score documentation](https://docs.typesafe.ai/primitives/score).
