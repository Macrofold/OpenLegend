...
September 25 data-design decisions: prioritize a shared world divided into regions while supporting independent worlds; preserve important events and summaries while allowing routine detail to expire under an explicit retention policy; and keep human-private messages and private character notes inaccessible to world creators. These are product directions, not implemented scale/privacy claims. [Scale and retention](../07-technical-architecture/data-delivery-and-scale.md) and [query privacy](../07-technical-architecture/data-queries-and-mcp.md#human-private-content-boundary) own their contracts and remaining qualification.
