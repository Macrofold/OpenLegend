...
Current cognition behavior lives in [Memory architecture](../../docs/memory-architecture.md), and narration behavior lives in [Narration, agent responses and conversations](../../docs/narration-and-conversations.md). This source file is retained only as historical input.
