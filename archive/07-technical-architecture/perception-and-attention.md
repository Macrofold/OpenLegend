...
The [acoustic quantity and threshold contract](../../docs/hearing-and-speech.md#2-continuous-quantities-three-thresholds) specifies continuous referenced decibel values rather than normalized hearing scores. Its [geometry and noise boundary](../../docs/hearing-and-speech.md#3-geometry-attenuation-and-noise) defines transmission semantics and the initial direct-path approximation. That contract owns tuning, units and supported fidelity; this section does not define a competing acoustic formula. Broader sustained sound processes remain future work, and caption lifetimes never stand in for physical emission durations.

The game's audibility model differs from the user's speaker volume or mute setting. Muting playback should not make the character deaf; accessible captions receive the same permitted sound evidence. [Spatial captions](../../docs/hearing-and-speech.md#8-listener-centered-directional-captions) and [timed UI](../../docs/timed-ui.md) specify presentation without enlarging sensory authority.
