...
The [production checklist](production-data-model.md#15-implementation-checklist) tracks persistence status. D0–D2 are incremental baseline work for consumed features; generic replay/archive drills are conditional on enabling those recovery capabilities. D3 expands queries for named consumers, D4 follows invention/sharing features, D5 gates external hosting, and D6 requires measured growth. None requires every catalog table before cognition.
