# Game inspiration and industry reference library

**Purpose: gameplay inspiration and reference—not an architecture specification, approved product decision, or implementation backlog.** This collection preserves the game research produced in the September 22–23 conversation and extends it with more granular mechanics research. Suggestions and proposed play studies are ideas to consider, not instructions to build them. No maintainer task tracker is created for this library.
...
- **[Camera and audience](essays/camera-audience-popularity-and-the-non-fps-argument.md):** evidence for non-FPS demand, without unsupported age or camera-causality claims.
...
[Evidence interpretation](essays/how-to-interpret-the-evidence.md) · [Review notebook](references/review-evidence.md) · [Popularity/economics ledger](references/popularity-and-economics.md) · [Source annotations](references/sources-01.md) · [Original bibliography](references/master-bibliography.md) · [Earlier additional findings](references/earlier-additional-findings.md).
