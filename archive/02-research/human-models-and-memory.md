...
**Accepted application policy:** hourly small-model consolidation merges repetitive raw experience older than six game hours, preserves consequential episodes and unresolved promises, and removes low-value detail. Independent background reflection can derive tentative lessons; dreams follow the configured continuous-sleep threshold (two hours by default); physical sleep follows the [saved energy policy](../../docs/worlds/base/sleep.md). Dreaming is fictional subjective reinterpretation, not the maintenance mechanism or a scientifically faithful account of sleep. Imagined scenes remain attributed as imagination, never authoritative history.
