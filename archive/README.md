...
For the subsequent critical review, start with [architecture findings and the revised build sequence](07-technical-architecture/review-and-delivery-plan.md). It records weaknesses corrected in the detailed documents, remaining feasibility risks, and separate gates for later features.
...
| `07-technical-architecture/` | Current implementation proposals and explicit service boundaries; unimplemented | [Index](07-technical-architecture/README.md); [system architecture](07-technical-architecture/system-architecture.md); [context/inference](07-technical-architecture/context-and-inference.md); [declarations](07-technical-architecture/declarations-and-evolution.md); [Macrofold handoff](07-technical-architecture/macrofold-implementation-brief.md) |
...
**Generative architecture:** [technical architecture](07-technical-architecture/system-architecture.md) → [context/inference](07-technical-architecture/context-and-inference.md) → [declarations/evolution](07-technical-architecture/declarations-and-evolution.md). The earlier interaction protocol and capability lifecycle retain examples and history. Copy the [Macrofold brief](07-technical-architecture/macrofold-implementation-brief.md) for downstream platform implementation.
