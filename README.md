...
Drag with the primary or middle button to pan; right-drag rotates and tilts smoothly. A stationary right-click opens actions on release. Scroll to zoom or use the camera buttons to zoom/recenter and the View control for rotation, tilt, projection and floor focus. Dismissing a menu by clicking the world never walks.
